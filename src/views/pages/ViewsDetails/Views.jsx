        ...
        <div className="container h-100" >
            <div className='w-75 bg-white referenceTable'>
                <div className='container'>
                    <p><b>Reference objective <span>{details.title}</span></b></p>
                </div>
                            ...
                            return (
                                <>
                                    <div key={index} className='container justify-content-between'>
                                        ...
                                        <p key={item.id}><b>{item.score ? item.score.toFixed(1) : ""}%</b></p>
                                    </div>
                                                ...
                                                <div key={index} className='inputBtn justify-content-center'>
                                                    <li key={index}>
                                                        <input type="button"
                                                            ...
                                                            key={index} id='input' name={sub.emotionId} value=''
                                                        />
                                                    </li>
                ...
                <div className='d-flex justify-content-end mx-3'>
                    <Link to={'/details/' + id + '/edit'} className='btn btn-primary w-25' id='editBtn' >Edit</Link>
                </div>
            </div>
