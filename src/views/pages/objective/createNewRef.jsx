                ...
                <div className="container border border-3 p-0 h-100 w-50 d-inline-block mt-3 bg-white">
                    <div className="border border-bottom mb-4 createObj" >
                        <div className="px-4 mt-5">
                            <label className=""><b>Title of the Refrence objective</b></label>
                            <br />
                            <input type="text"
                                name='title'
                                className="w-100"
                            ...
                            return (
                                <div key={index}>
                                    <div className="mt-5 mb-3 mx-0 p-3 bg-light" id='subObjective'>
                                        ...
                                        <IconButton disabled={index == 0} onClick={event => handleRemoveFields(index, event)}>
                                            <RemoveIcon />
                                        </IconButton>
                                        <br />
                                        <input type="text"
                        ...
                        <button className="border border-dark border-2 rounded-3 float-end mx-2" id="subBtn" onClick={() => AddsubObjective()}>+ Add Sub Objective</button>
                    </div>
                    <div className="container w-100 d-flex justify-content-center">
                        <Link className="btn text-white w-50" to='/' id="createObjLink" onClick={handleSubmit}>Create</Link>
                    </div>
                </div>
